VideosTags1 = '''Lose Yourself (Musical Recording)
Hip Hop Music (Musical Genre)
Eminem (Music Video Performer)
Rap Rock (Musical Genre)
Music (TV Genre)
8 Mile (Film)
8 Mile (Soundtrack)
The Slim Shady LP (Musical Album)
official
Trailer (Website Category)
MTV (TV Network)
Music Video (TV Genre)
libra
The Marshall Mathers LP (Musical Album)'''
...
stressed out video
stressed out official video
stressed out fueled by ramen
stressed out FBR
...
top ride ride top
skeleton clique
Im falling so Im taking my time on my ride
oh Im falling so Im taking my time on my ride
...
Rap
'''
VideosTags9 = '''snowrunner
snowrunner gameplay
snowrunner gameplay part 1
snowrunner part 1
snowrunner walkthrough part 1
snowrunner best heavy truck
'''
VideosTags10 = '''snowrunner
snowrunner gameplay
snowrunner playtrough
snowrunner heavy duty cars
snowrunner walktrough
snowrunner trailer
SnowRunner Top Twitch Funny Moments Compilation
SnowRunner funny moments
SnowRunner compilation
SnowRunner trucking simulator
SnowRunner best simulator
...
#CS:GO's Grenade Blast Update

VideosTags18 = '''counter-strike global offensive
gameplay
counter-strike
CS:GO
cs
